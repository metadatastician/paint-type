...
= Dev Container Usage
:author: Joshua Jewell <paint-type@pm.me>
...
Replace `paint-type` placeholders in both `devcontainer.json` and `Containerfile` with your actual project name. Run `just deps` to verify the environment after first launch.
