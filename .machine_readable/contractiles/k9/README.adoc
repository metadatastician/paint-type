...
**See:** https://github.com/hyperpolymath/k9iser/blob/main/docs/SECURITY-BEST-PRACTICES.adoc
...
git clone https://github.com/hyperpolymath/k9iser.git
----

== Learn More

- **K9-SVC Specification:** https://github.com/hyperpolymath/k9iser/blob/main/SPEC.adoc
- **K9 User Guide:** https://github.com/hyperpolymath/k9iser/blob/main/GUIDE.adoc
- **Security Documentation:** https://github.com/hyperpolymath/k9iser/blob/main/docs/SECURITY-FAQ.adoc
...
**Questions?** Open an issue on https://github.com/hyperpolymath/k9iser
