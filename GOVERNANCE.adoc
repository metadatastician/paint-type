...
This repository follows a **Dual Maintainer Governance Model**:

* Lead maintainer (@hyperpolymath) and co-maintainer (@metadatastician) have authority over the project
* All contributions are welcome and reviewed by the maintainers
* Decisions are made transparently through GitHub issues and discussions
* The project adheres to the hyperpolymath and metadatastician estate policies where applicable
...
| **Maintainer** | Write access, merge rights, admin | @hyperpolymath, @metadatastician
