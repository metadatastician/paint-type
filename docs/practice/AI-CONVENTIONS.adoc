...
- All original code: **AGPL-3.0-or-later with PMPL-1.0-or-later fallback**
...
- Copyright: `Copyright (c) 2026 Joshua Jewell (JoshuaJewell) <paint-type@pm.me>`
...
- FFI implementation: **Zig** with C ABI compatibility (`src/interface/ffi/`).
