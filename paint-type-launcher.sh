...
#
# ============================================================================
# paint-type-launcher.sh — paint.type
# ============================================================================
# GENERATED by launch-scaffolder from paint-type.launcher.a2ml.
...
APP_DESC="The open, cross-platform image editor Paint.NET users are actually asking for"
APP_CATEGORIES="Graphics;Editor;Development;"
APP_GENERIC_NAME="paint.type"
...
CONFIG_FILE="/home/hyperpolymath/developer/meta-repos/paint-type/paint-type.launcher.a2ml"

URL=""


PID_FILE="${XDG_RUNTIME_DIR:-${TMPDIR:-/tmp}}/paint-type.pid"
LOG_FILE="${XDG_STATE_HOME:-$HOME/.local/state}/paint-type/paint-type.log"

# Search list from [runtime].startup-command-search — first executable wins.
START_COMMAND=""
for candidate in \
    "/target/release/paint-type" \
    "/paint-type" \
    "paint-type" \
    ; do
    if [ -x "$candidate" ]; then
...
[runtime].startup-command-search or [runtime].command in paint-type.launcher.a2ml."
            return 1
        fi
    fi
