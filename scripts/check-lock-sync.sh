...
# Return the canonical owner/repo@ref for an external action or reusable-workflow
# reference, discarding any subpath. Return "" for local or unrecognized refs.
...
# Return a comparison key with only the OWNER/REPO segment folded to lowercase.
# GitHub resolves
